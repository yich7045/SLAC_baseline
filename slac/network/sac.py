...
class GaussianPolicy(torch.jit.ScriptModule):
    ...
    def __init__(self, action_shape, num_sequences, img_feature_dim, tactile_latent_dim, hidden_units=(256, 256)):
        super(GaussianPolicy, self).__init__()

        # NOTE: Conv layers are shared with the latent model.
        self.net = build_mlp(
            input_dim=num_sequences * img_feature_dim + num_sequences * tactile_latent_dim + (num_sequences - 1) * action_shape[0],
